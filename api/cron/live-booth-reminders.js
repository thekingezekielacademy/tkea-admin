            ...
            try {
              ...
              if (['1h_before', '30m_before', '2m_before', 'start'].includes(timing)) {
                try {
                  ...
                  const telegramChannelId = process.env.TELEGRAM_CHANNEL_ID || telegramChannel;
...
See you there! 🎓`;
                  ...
                  if (telegramResponse.ok) {
                    ...
                    console.log(`✅ Telegram reminder sent for session ${session.id} (${timing})`);
                    ...
                    await supabaseAdmin
                      ...
                      .insert({
                        ...
                        recipient_telegram_id: telegramChannelId,
                        status: 'sent'
                      });
