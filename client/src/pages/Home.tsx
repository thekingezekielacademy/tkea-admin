...
// import PWAInstall from '../components/PWAInstall'; // REMOVED: PWA install causes issues in mini browsers
...
const Home: React.FC = () => {
  return (
    <>
      ...
      {/* PWA Install Section - Mobile Only - REMOVED: Causes issues in mini browsers */}
      {/* <PWAInstall /> */}
