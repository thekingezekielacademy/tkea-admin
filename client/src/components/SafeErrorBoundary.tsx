...
const DefaultFallback = ({ error, resetError }: { error: unknown; resetError: () => void }) => {
      ...
      <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-6">
        <div className="flex items-center mb-4">
          ...
          <div className="ml-3">
            ...
            <p className="text-xs text-gray-400 mt-1">Error: {errorMessage}</p>
          </div>
        </div>
  ...
  return (
    <Sentry.ErrorBoundary 
      ...
      beforeCapture={(scope, error) => {
        ...
        scope.setTag('errorBoundary', 'SafeErrorBoundary');
