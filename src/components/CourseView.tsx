    ...
    if (courseId) {
      ...
      const fetchData = async () => {
        ...
        try {
          ...
          // Fetch PDF resources
          const { data: pdfResourcesData, error: resourcesError } = await supabase
          ...
          setPdfResources(pdfResourcesData || []);
            ...
            <div className="lg:col-span-1">
              ...
              {pdfResources.length > 0 && (
                <div className="bg-white rounded-lg shadow-lg p-6 mt-6">
                  ...
                  <p className="text-sm text-gray-600 mb-4">Download PDF resources for this course</p>
                  <div className="space-y-3">
                    {pdfResources.map((pdf) => (
                      <a
                        ...
                        className="flex items-center justify-between p-4 rounded-lg border border-gray-200 hover:border-indigo-500 hover:bg-indigo-50 transition-all duration-200 group"
                      >
                        <div className="flex items-center space-x-3 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="font-medium text-gray-900 group-hover:text-indigo-900 truncate">
                              {pdf.name}
                            </p>
                            {pdf.file_size && (
                              <p className="text-sm text-gray-500">
